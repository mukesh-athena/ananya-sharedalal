      ...
      <main style={{ backgroundColor: 'var(--offwhite)', color: 'var(--inkbrown)', paddingTop: '0' }}>
        ...
        <section style={{ padding: '7rem 2rem' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            ...
            <div style={{ width: '100%', margin: '2rem 0' }}>
              ...
              <p style={figureCaption}>Image 1: Field visit shadowing ASHA workers</p>
            </div>
        ...
        <section style={{ backgroundColor: 'var(--parchment)', padding: '7rem 2rem' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            ...
            <div style={{ width: '100%', margin: '2rem 0' }}>
              ...
              <p style={figureCaption}>Image 2: Saturday immunisation at the Anganwadi school</p>
            </div>
        ...
        <section style={{ padding: '7rem 2rem' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            {/* IMAGE 6 */}
            <div style={{ width: '100%', margin: '2rem 0' }}>
              <Image src="/images/asha-3.jpg" alt="Parent-Teacher Meeting event on a Thursday at Zila Parishad High School where ASHA workers were checking height and weight and distributing iron and deworming tablets" width={1200} height={900} sizes="100vw" style={{ width: '100%', height: 'auto', display: 'block' }} />
              <p style={figureCaption}>Image 6: Parent-Teacher Meeting event on a Thursday at Zila Parishad High School where ASHA workers were checking height and weight and distributing iron and deworming tablets</p>
            </div>
